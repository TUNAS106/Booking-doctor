...
export {
    ...
    getTopDoctorHomeFromApi, getAllDoctorsFromApi, saveDetailInforDoctorFromApi, getDetailDoctorByIdFromApi, bulkCreateScheduleFromApi, getScheduleByDateFromApi
};
